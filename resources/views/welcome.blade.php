    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Home Link -->
                <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')" class=" text-gray-800 dark:text-gray-100 hover:text-[#FF2D20] ml-4">
                    {{ __('Home') }}
                </x-nav-link>
            </div>
            <!-- Navigation Links on the Right -->
            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex justify-end">
                <x-nav-link :href="route('login')" :active="request()->routeIs('login')" class="text-gray-800 dark:text-gray-100 hover:text-[#FF2D20]">
                    {{ __('Log In') }}
                </x-nav-link>
                <x-nav-link :href="route('register')" :active="request()->routeIs('register')" class="text-gray-800 dark:text-gray-100 hover:text-[#FF2D20]">
                    {{ __('Sign Up') }}
                </x-nav-link>
            </div>
        </div>
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                <header class="flex justify-between items-center py-4">
                    <div class="flex items-center">
                        <svg class="h-12 w-auto text-[#FF2D20]" viewBox="0 0 62 65" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="..."/></svg>
                    </div>
                </header>
